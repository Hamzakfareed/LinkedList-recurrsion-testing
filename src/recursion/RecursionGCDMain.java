 ...
 * 
 * Compile and run this file against your solution to Gcd method in Recursion.java
 * 
 ...
 */
	...
	public void testGcd2and1000() {
		try{
			int result = Recursion.gcd(2, 1000);
	...
	public void testGcd3and1000() {
		try{
			int result = Recursion.gcd(3, 1000);
	...
	public void testGcd1000and3() {
		try{
			int result = Recursion.gcd(1000, 3);
	...
	public void testGcd1000and600() {
		try{
			int result = Recursion.gcd(1000, 600);
	...
	public void testGcd1001and991() {
		try{
			int result = Recursion.gcd(1001, 991);
	...
	public void testGcd1002and992() {
		try{
			int result = Recursion.gcd(1002, 992);
